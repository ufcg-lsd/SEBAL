...
daysSince1970 = (acquired_date - date1970)
...
create_alb_file(dados, fic)
create_evi_file(dados, fic)
create_g_file(dados, fic)
create_lai_file(dados, fic)
create_ndvi_file(dados, fic)
create_rn_file(dados, fic)
create_ts_file(dados, fic)
proc.time()
