...
raster.elevation.aux <- raster(fic.elevation)
...
raster.elevation.ncols = raster.elevation@ncols
raster.elevation.nrows = raster.elevation@nrows
...
phase2 <- function() {
  ...
  ##### Clean memory #####
  rm(ustar, H, L, y_0.1, y_2, x200, psi_0.1, psi_2, psi_200)
  gc()
  ########################
